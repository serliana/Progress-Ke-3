    ...
    public static void main(String[] args) {
        ...
        GAME: while (running) {
            ...
            while (enemyHealth > 0) {
                ...
                System.out.println("\t2. Minum ramuan Health");
                System.out.println("\t3. Lari dari musuh");
                ...
                if (input.equals("1")) {
                    ...
                    if (numHealthPotion > 0) {
                        ...
                        numHealthPotion--;
                        System.out.println("\n\t> " + player + " minum ramuan Health.\n\tMenyembuhkanmu untuk "
                                + healthPotionHealAmount + "." + "\n\t> " + player + " sekarang " + health + " HP."
                                + "\n\t" + numHealthPotion + " Sisa ramuan. \n");
                    } else {
                        System.out.println(
                                "\n\tKamu tidak memiliki ramuan Health yang tersisa!\n\tKalahkan musuh untuk mendapatkan kesempatan melanjutkan!\n");
                    }
            ...
            if (rand.nextInt(100) < healthPotionDropChance) {
                numHealthPotion++;
                System.out.println("\t" + enemy + " menjatuhkan ramuan Health! ");
                System.out.println("\tKamu sekarang memiliki " + numHealthPotion + " ramuan Health.");
            }
